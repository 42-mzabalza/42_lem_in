...
/*   Updated: 2018/06/20 17:31:11 by mzabalza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					main();
int					goto_alist(char *t0, char *t1, t_glist *g, t_adjlist *a);
...
int					get_nb_ants();
int					skip_comment(t_adjlist *adjlist, char **line);
...
int					free_alist_error(t_adjlist *a, t_gpath *g, int i, char *s);
